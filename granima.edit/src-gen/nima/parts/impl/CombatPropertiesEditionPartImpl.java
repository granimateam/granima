 ...
 * 
 */
public class CombatPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, CombatPropertiesEditionPart {
	 ...
	 * 
	 */
	public CombatPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(combatStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == NimaViewsRepository.Combat.Properties.nbRound) {
					return createNbRoundText(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(NimaMessages.CombatPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNbRoundText(Composite parent) {
		SWTUtils.createPartLabel(parent, NimaMessages.CombatPropertiesEditionPart_NbRoundLabel, propertiesEditionComponent.isRequired(NimaViewsRepository.Combat.Properties.nbRound, NimaViewsRepository.SWT_KIND));
		nbRound = new Text(parent, SWT.BORDER);
		...
		nbRound.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CombatPropertiesEditionPartImpl.this, NimaViewsRepository.Combat.Properties.nbRound, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, nbRound.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(NimaViewsRepository.Combat.Properties.nbRound, NimaViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
