 ...
 * 
 */
public class UniversPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, UniversPropertiesEditionPart {
...
protected List<ViewerFilter> combatsFilters = new ArrayList<ViewerFilter>();
	 ...
	 * 
	 */
	public UniversPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(universStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == NimaViewsRepository.Univers.Properties.combats) {
					return createCombatsAdvancedTableComposition(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(NimaMessages.UniversPropertiesEditionPart_PropertiesGroupLabel);
	 ...
	 * 
	 */
	protected Composite createCombatsAdvancedTableComposition(Composite parent) {
		this.combats = new ReferencesTable(NimaMessages.UniversPropertiesEditionPart_CombatsLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UniversPropertiesEditionPartImpl.this, NimaViewsRepository.Univers.Properties.combats, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				combats.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UniversPropertiesEditionPartImpl.this, NimaViewsRepository.Univers.Properties.combats, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				combats.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UniversPropertiesEditionPartImpl.this, NimaViewsRepository.Univers.Properties.combats, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				combats.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UniversPropertiesEditionPartImpl.this, NimaViewsRepository.Univers.Properties.combats, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				combats.refresh();
			}
		...
		this.combats.setHelpText(propertiesEditionComponent.getHelpContent(NimaViewsRepository.Univers.Properties.combats, NimaViewsRepository.SWT_KIND));
		this.combats.createControls(parent);
		this.combats.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UniversPropertiesEditionPartImpl.this, NimaViewsRepository.Univers.Properties.combats, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
