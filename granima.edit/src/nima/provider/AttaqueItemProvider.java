...
public class AttaqueItemProvider
	...
	protected void addBonusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attaque_bonus_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attaque_bonus_feature", "_UI_Attaque_type"),
				 NimaPackage.Literals.ATTAQUE__BONUS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Attaque_type") + " " + attaque.getBonus();
	}
