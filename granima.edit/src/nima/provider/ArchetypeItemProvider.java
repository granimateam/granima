...
public class ArchetypeItemProvider
	...
	/**
	 * This adds a property descriptor for the Nb Action feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNbActionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Archetype_nbAction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Archetype_nbAction_feature", "_UI_Archetype_type"),
				 NimaPackage.Literals.ARCHETYPE__NB_ACTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Peut Agir feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPeutAgirPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Archetype_peutAgir_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Archetype_peutAgir_feature", "_UI_Archetype_type"),
				 NimaPackage.Literals.ARCHETYPE__PEUT_AGIR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Rolled Init feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addRolledInitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Archetype_rolledInit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Archetype_rolledInit_feature", "_UI_Archetype_type"),
				 NimaPackage.Literals.ARCHETYPE__ROLLED_INIT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
