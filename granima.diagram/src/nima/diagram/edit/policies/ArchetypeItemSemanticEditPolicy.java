 ...
 * @generated
 */
public class ArchetypeItemSemanticEditPolicy extends
		NimaBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ArchetypeItemSemanticEditPolicy() {
		super(NimaElementTypes.Archetype_2001);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (NimaElementTypes.Config_3001 == req.getElementType()) {
			return getGEFWrapper(new ConfigCreateCommand(req));
		}
