...
import nima.diagram.edit.commands.ConfigEnchaineCreateCommand;
import nima.diagram.edit.commands.ConfigEnchaineReorientCommand;
 ...
 * @generated
 */
public class ConfigItemSemanticEditPolicy extends
	...
	public ConfigItemSemanticEditPolicy() {
		super(NimaElementTypes.Config_3001);
	}
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (NimaElementTypes.ConfigEnchaine_4004 == req.getElementType()) {
			return getGEFWrapper(new ConfigEnchaineCreateCommand(req,
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case ConfigEnchaineEditPart.VISUAL_ID:
			return getGEFWrapper(new ConfigEnchaineReorientCommand(req));
		}
