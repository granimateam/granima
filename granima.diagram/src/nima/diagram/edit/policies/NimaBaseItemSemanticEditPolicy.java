 ...
 * @generated
 */
public class NimaBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected NimaBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						NimaVisualIDRegistry.getVisualID((View) view));
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = NimaElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = NimaDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			NimaDiagramEditorPlugin.getInstance().setLinkConstraints(
