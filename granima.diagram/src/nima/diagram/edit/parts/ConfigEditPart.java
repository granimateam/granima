 ...
 * @generated
 */
public class ConfigEditPart extends AbstractBorderItemEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ConfigItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ConfigFigure();
	}

	/**
	 * @generated
	 */
	public ConfigFigure getPrimaryShape() {
		return (ConfigFigure) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class ConfigFigure extends RectangleFigure {
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 120, 140, 160);
