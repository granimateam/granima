 ...
 * @generated
 */
public class ArchetypeHpEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ArchetypeHpEditPart(View view) {
		super(view);
	}
			...
			parser = NimaParserProvider
					.getParser(
							...
							NimaVisualIDRegistry
									.getType(nima.diagram.edit.parts.ArchetypeHpEditPart.VISUAL_ID));
		}
		return parser;
	}
