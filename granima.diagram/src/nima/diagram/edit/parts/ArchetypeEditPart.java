 ...
 * @generated
 */
public class ArchetypeEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public ArchetypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(
						NimaVisualIDRegistry.TYPED_INSTANCE));
		super.createDefaultEditPolicies();
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ArchetypeItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ArchetypeCanonicalEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		FlowLayoutEditPolicy lep = new FlowLayoutEditPolicy() {
			...
			protected EditPolicy createChildEditPolicy(EditPart child) {
				...
				switch (NimaVisualIDRegistry.getVisualID(childView)) {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ArchetypeNomEditPart) {
			((ArchetypeNomEditPart) childEditPart).setLabel(getPrimaryShape()
		...
		if (childEditPart instanceof ConfigEditPart) {
			...
			getBorderedFigure().getBorderItemContainer().add(
					((ConfigEditPart) childEditPart).getFigure(), locator);
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ConfigEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((ConfigEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(NimaVisualIDRegistry
				.getType(ArchetypeNomEditPart.VISUAL_ID));
	}
	...
	public class ArchetypeFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureArchetypeNomFigure = new WrappingLabel();

			fFigureArchetypeNomFigure.setText("Boby");
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureArchetypeNomFigure() {
			return fFigureArchetypeNomFigure;
		}
