...
import nima.diagram.edit.policies.NimaTextSelectionEditPolicy;
import nima.diagram.part.NimaVisualIDRegistry;
import nima.diagram.providers.NimaElementTypes;
import nima.diagram.providers.NimaParserProvider;
 ...
 * @generated
 */
public class ArchetypeNomEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ArchetypeNomEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new NimaTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new CombatEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return NimaElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = NimaParserProvider
					.getParser(
							NimaElementTypes.Archetype_2001,
							getParserElement(),
							NimaVisualIDRegistry
									.getType(nima.diagram.edit.parts.ArchetypeNomEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					NimaEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
