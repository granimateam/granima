 ...
 * @generated
 */
public class ArchetypeLabelExpressionLabelParser extends
		ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public ArchetypeLabelExpressionLabelParser() {
	}
	...
	protected String getExpressionBody() {
		return NimaOCLFactory.getExpression(0,
				NimaPackage.eINSTANCE.getArchetype(), null).body();
	}
