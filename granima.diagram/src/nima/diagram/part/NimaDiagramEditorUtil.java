 ...
 * @generated
 */
public class NimaDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.NimaDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									Messages.NimaDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = NimaDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor.beginTask(
				Messages.NimaDiagramEditorUtil_CreateDiagramProgressTask, 3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.NimaDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				Combat model = createInitialModel();
				...
				try {
					modelResource.save(nima.diagram.part.NimaDiagramEditorUtil
							.getSaveOptions());
					diagramResource
							.save(nima.diagram.part.NimaDiagramEditorUtil
									.getSaveOptions());
				} catch (IOException e) {
	 ...
	 * @generated
	 */
	private static Combat createInitialModel() {
		return NimaFactory.eINSTANCE.createCombat();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(Combat model, Resource resource) {
