 ...
 * @generated
 */
public class NimaParserProvider extends AbstractProvider implements
		IParserProvider {
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(NimaVisualIDRegistry.getVisualID(vid));
		}
		View view = (View) hint.getAdapter(View.class);
		if (view != null) {
			return getParser(NimaVisualIDRegistry.getVisualID(view));
		}
		return null;
	}
	...
	public boolean provides(IOperation operation) {
		if (operation instanceof GetParserOperation) {
			...
			if (NimaElementTypes.getElement(hint) == null) {
				return false;
			}
