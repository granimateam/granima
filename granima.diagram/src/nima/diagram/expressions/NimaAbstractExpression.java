 ...
 * @generated
 */
public abstract class NimaAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = NimaDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected NimaAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
